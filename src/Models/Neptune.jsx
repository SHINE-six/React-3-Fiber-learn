...
const Neptune = ({ handleThisCameraPosition, handleExit }) => {
    const gltf = useLoader(GLTFLoader, 'src/Assets/3d/neptune.glb');
    ...
    return (
        <mesh ref={VenusRef} scale={10} position={[distance,0,0]} onClick={handleClick} onPointerMissed={handleMissed}>
